  ...
  <div class='side-col' id='sidebar'>
    ...
    <div class='cell'>
      ...
      <div class='text-center'>
        <?php /* 同步钉钉部门 */ common::printLink('dingtalk', 'syncdept', '', $lang->company->syncding, '', "class='btn btn-info btn-wide'");?>
      </div>
    </div>
  </div>
  <div class='main-col'>
    ...
    <form class='main-table table-user' data-ride='table' action='<?php echo $this->createLink('user', 'batchEdit', "deptID=$deptID")?>' method='post' id='userListForm'>
      ...
      <table class='table has-sort-head' id='userList'>
        ...
        <tr>
          ...
          <th><?php echo $lang->company->bindding;?></th>
        ...
        <tr>
          ...
          <td><?php echo (trim($user->dt_openid)=='') ? '否':'是'; ?></td>
